      ...
      <main>
        ...
        <section className="relative min-h-[870px] flex items-center overflow-hidden w-full max-w-max-width mx-auto">
          <div className="absolute inset-0 z-0 bg-background">
            <Image
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuBxGt0-WnOxPkBwnse2v_iCBoK7nejQ2k2JkkYO5I23BnOWW0tey0ICvusjoVAdiDcNmOeHUcWcejEBHK-G6-CEu7oEfQhSXDu_QM7n15naV1DIbcACLAHR4A-9eSWkuBl3ojymoL-gmg5fa1VxXYCC9XQT7fuILVG6pchraSqH0s8rVDrxxztZ-AYEnIo0LxzwHjm8NjMAHQ3A9C5NdvzE5-w7vyLZDhusabEgMV8WSn7EW2p6yAceOOuosBekhwk81DJRrZ0"
              alt="Hero Background"
              fill
              priority
